...
namespace SPSync.Core.Metadata
{
    ...
    [Serializable]
    public class MetadataItemOld
    {
        public MetadataItemOld() { }

        internal MetadataItemOld(string localPath, ItemType type)
        {
            Id = Guid.NewGuid();
            SharePointId = -1;
            ETag = -1;
        ...
        internal MetadataItemOld(int sharePointId, int etag, string name, string localFolder, DateTime lastModified, ItemType type)
        {
            Id = Guid.NewGuid();
